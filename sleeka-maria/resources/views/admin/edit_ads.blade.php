        ...
        <div class="container">
                <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                        <div class="container-fluid">
                            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Edit Ads</a>
                            <!-- User -->
        ...
        <div class="container">
            <div class="row mt-3">
                ...
                <form action="{{route('ads.update',['id' => $ads->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    @method('put')
                        <div class="form-group">
                            <label for="productCoverImage">Edit Cover Image </label>
                ...
                <div class="row form-row mt-3">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" value="{{$ads->ads_name}}" placeholder="title" name="ads_name">
                    </div>
                </div>
