            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="collapse container" id="collapseOrders">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="rejected_orders.html">
                                Rejected Orders
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="main-content">
        <div class="container">
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Rejected Orders</a>
                    <!-- User -->
            ...
            <div class="container">
                <div class="row align-items-center mt-3 bg-dark">
                    <div class="col">
                        <h3 class="mb-0 text-white">Rejected Orders</h3>
                    </div>
