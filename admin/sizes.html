            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="collapse container" id="collapseProducts">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="sizes.html">
                                Sizes
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="main-content">
        <div class="container">
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <a class="h2 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="">Products Size</a>
                    <!-- User -->
        ...
        <div class="container">
            <div class="input-group mt-3 mb-3">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary" type="button">Add Size</button>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="category.html" type="button" class="btn btn-danger">Delete Size</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
